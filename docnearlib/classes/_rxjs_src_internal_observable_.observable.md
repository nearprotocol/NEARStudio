[rxjs](../README.md) > ["rxjs/src/internal/Observable"](../modules/_rxjs_src_internal_observable_.md) > [Observable](../classes/_rxjs_src_internal_observable_.observable.md)
...
↳  [Subject](_rxjs_src_internal_subject_.subject.md)

↳  [AjaxObservable](_rxjs_src_internal_observable_dom_ajaxobservable_.ajaxobservable.md)

↳  [ConnectableObservable](_rxjs_src_internal_observable_connectableobservable_.connectableobservable.md)

↳  [GroupedObservable](_rxjs_src_internal_operators_groupby_.groupedobservable.md)

↳  [SubscribeOnObservable](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md)
...
* [constructor](_rxjs_src_internal_observable_.observable.md#constructor)

### Properties

* [_isScalar](_rxjs_src_internal_observable_.observable.md#_isscalar)
* [operator](_rxjs_src_internal_observable_.observable.md#operator)
* [source](_rxjs_src_internal_observable_.observable.md#source)
* [if](_rxjs_src_internal_observable_.observable.md#if)
* [throw](_rxjs_src_internal_observable_.observable.md#throw)

### Methods

* [__computed](_rxjs_src_internal_observable_.observable.md#__computed)
* [_subscribe](_rxjs_src_internal_observable_.observable.md#_subscribe)
* [_trySubscribe](_rxjs_src_internal_observable_.observable.md#_trysubscribe)
* [forEach](_rxjs_src_internal_observable_.observable.md#foreach)
* [lift](_rxjs_src_internal_observable_.observable.md#lift)
* [pipe](_rxjs_src_internal_observable_.observable.md#pipe)
* [subscribe](_rxjs_src_internal_observable_.observable.md#subscribe)
* [toPromise](_rxjs_src_internal_observable_.observable.md#topromise)
* [create](_rxjs_src_internal_observable_.observable.md#create)
...
⊕ **new Observable**(subscribe?: *`function`*): [Observable](_rxjs_src_internal_observable_.observable.md)
...
**Returns:** [Observable](_rxjs_src_internal_observable_.observable.md)
...
▸ **_subscribe**(subscriber: *[Subscriber](_rxjs_src_internal_subscriber_.subscriber.md)<`any`>*): [TeardownLogic](../modules/_rxjs_src_internal_types_.md#teardownlogic)

*Defined in rxjs/src/internal/Observable.ts:266*
