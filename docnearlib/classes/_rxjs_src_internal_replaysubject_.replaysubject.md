[rxjs](../README.md) > ["rxjs/src/internal/ReplaySubject"](../modules/_rxjs_src_internal_replaysubject_.md) > [ReplaySubject](../classes/_rxjs_src_internal_replaysubject_.replaysubject.md)
...
* [constructor](_rxjs_src_internal_replaysubject_.replaysubject.md#constructor)

### Properties

* [_bufferSize](_rxjs_src_internal_replaysubject_.replaysubject.md#_buffersize)
* [_events](_rxjs_src_internal_replaysubject_.replaysubject.md#_events)
* [_infiniteTimeWindow](_rxjs_src_internal_replaysubject_.replaysubject.md#_infinitetimewindow)
* [_isScalar](_rxjs_src_internal_replaysubject_.replaysubject.md#_isscalar)
* [_windowTime](_rxjs_src_internal_replaysubject_.replaysubject.md#_windowtime)
* [closed](_rxjs_src_internal_replaysubject_.replaysubject.md#closed)
* [hasError](_rxjs_src_internal_replaysubject_.replaysubject.md#haserror)
* [isStopped](_rxjs_src_internal_replaysubject_.replaysubject.md#isstopped)
* [observers](_rxjs_src_internal_replaysubject_.replaysubject.md#observers)
* [operator](_rxjs_src_internal_replaysubject_.replaysubject.md#operator)
* [scheduler](_rxjs_src_internal_replaysubject_.replaysubject.md#scheduler)
* [source](_rxjs_src_internal_replaysubject_.replaysubject.md#source)
* [thrownError](_rxjs_src_internal_replaysubject_.replaysubject.md#thrownerror)
* [if](_rxjs_src_internal_replaysubject_.replaysubject.md#if)
* [throw](_rxjs_src_internal_replaysubject_.replaysubject.md#throw)

### Methods

* [__computed](_rxjs_src_internal_replaysubject_.replaysubject.md#__computed)
* [_getNow](_rxjs_src_internal_replaysubject_.replaysubject.md#_getnow)
* [_subscribe](_rxjs_src_internal_replaysubject_.replaysubject.md#_subscribe)
* [_trimBufferThenGetEvents](_rxjs_src_internal_replaysubject_.replaysubject.md#_trimbufferthengetevents)
* [_trySubscribe](_rxjs_src_internal_replaysubject_.replaysubject.md#_trysubscribe)
* [asObservable](_rxjs_src_internal_replaysubject_.replaysubject.md#asobservable)
* [complete](_rxjs_src_internal_replaysubject_.replaysubject.md#complete)
* [error](_rxjs_src_internal_replaysubject_.replaysubject.md#error)
* [forEach](_rxjs_src_internal_replaysubject_.replaysubject.md#foreach)
* [lift](_rxjs_src_internal_replaysubject_.replaysubject.md#lift)
* [next](_rxjs_src_internal_replaysubject_.replaysubject.md#next)
* [nextInfiniteTimeWindow](_rxjs_src_internal_replaysubject_.replaysubject.md#nextinfinitetimewindow)
* [nextTimeWindow](_rxjs_src_internal_replaysubject_.replaysubject.md#nexttimewindow)
* [pipe](_rxjs_src_internal_replaysubject_.replaysubject.md#pipe)
* [subscribe](_rxjs_src_internal_replaysubject_.replaysubject.md#subscribe)
* [toPromise](_rxjs_src_internal_replaysubject_.replaysubject.md#topromise)
* [unsubscribe](_rxjs_src_internal_replaysubject_.replaysubject.md#unsubscribe)
* [create](_rxjs_src_internal_replaysubject_.replaysubject.md#create)
...
⊕ **new ReplaySubject**(bufferSize?: *`number`*, windowTime?: *`number`*, scheduler?: *[SchedulerLike](../interfaces/_rxjs_src_internal_types_.schedulerlike.md)*): [ReplaySubject](_rxjs_src_internal_replaysubject_.replaysubject.md)

*Overrides [Subject](_rxjs_src_internal_subject_.subject.md).[constructor](_rxjs_src_internal_subject_.subject.md#constructor)*

*Defined in rxjs/src/internal/ReplaySubject.ts:20*
...
**Returns:** [ReplaySubject](_rxjs_src_internal_replaysubject_.replaysubject.md)
...
*Defined in rxjs/src/internal/ReplaySubject.ts:18*
...
**● _events**: *(`T` \| [ReplayEvent](_rxjs_src_internal_replaysubject_.replayevent.md)<`T`>)[]* =  []

*Defined in rxjs/src/internal/ReplaySubject.ts:17*

___
<a id="_infinitetimewindow"></a>

### `<Private>` _infiniteTimeWindow

**● _infiniteTimeWindow**: *`boolean`* = false
...
*Defined in rxjs/src/internal/ReplaySubject.ts:19*
...
*Defined in rxjs/src/internal/ReplaySubject.ts:24*
...
*Defined in rxjs/src/internal/ReplaySubject.ts:97*
...
*Defined in rxjs/src/internal/ReplaySubject.ts:57*
...
___
<a id="_trimbufferthengetevents"></a>

### `<Private>` _trimBufferThenGetEvents

▸ **_trimBufferThenGetEvents**(): [ReplayEvent](_rxjs_src_internal_replaysubject_.replayevent.md)<`T`>[]

*Defined in rxjs/src/internal/ReplaySubject.ts:101*

**Returns:** [ReplayEvent](_rxjs_src_internal_replaysubject_.replayevent.md)<`T`>[]
...
*Inherited from [Subject](_rxjs_src_internal_subject_.subject.md).[next](_rxjs_src_internal_subject_.subject.md#next)*

*Defined in rxjs/src/internal/Subject.ts:59*
...
___
<a id="nextinfinitetimewindow"></a>

### `<Private>` nextInfiniteTimeWindow

▸ **nextInfiniteTimeWindow**(value: *`T`*): `void`

*Defined in rxjs/src/internal/ReplaySubject.ts:37*
...
___
<a id="nexttimewindow"></a>

### `<Private>` nextTimeWindow

▸ **nextTimeWindow**(value: *`T`*): `void`

*Defined in rxjs/src/internal/ReplaySubject.ts:49*
