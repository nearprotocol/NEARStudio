[rxjs](../README.md) > ["rxjs/src/internal/observable/SubscribeOnObservable"](../modules/_rxjs_src_internal_observable_subscribeonobservable_.md) > [SubscribeOnObservable](../classes/_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md)
...
* [constructor](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#constructor)

### Properties

* [_isScalar](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#_isscalar)
* [delayTime](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#delaytime)
* [operator](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#operator)
* [scheduler](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#scheduler)
* [source](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#source)
* [if](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#if)
* [throw](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#throw)

### Methods

* [__computed](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#__computed)
* [_subscribe](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#_subscribe)
* [_trySubscribe](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#_trysubscribe)
* [forEach](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#foreach)
* [lift](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#lift)
* [pipe](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#pipe)
* [subscribe](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#subscribe)
* [toPromise](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#topromise)
* [create](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#create)
* [dispatch](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md#dispatch)
...
⊕ **new SubscribeOnObservable**(source: *[Observable](_rxjs_src_internal_observable_.observable.md)<`T`>*, delayTime?: *`number`*, scheduler?: *[SchedulerLike](../interfaces/_rxjs_src_internal_types_.schedulerlike.md)*): [SubscribeOnObservable](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md)
...
*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:28*
...
| `Default value` scheduler | [SchedulerLike](../interfaces/_rxjs_src_internal_types_.schedulerlike.md) |  asap |

**Returns:** [SubscribeOnObservable](_rxjs_src_internal_observable_subscribeonobservable_.subscribeonobservable.md)
...
*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:31*
...
*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:32*
...
*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:30*
...
*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:43*
...
▸ **create**<`T`>(source: *[Observable](_rxjs_src_internal_observable_.observable.md)<`T`>*, delay?: *`number`*, scheduler?: *[SchedulerLike](../interfaces/_rxjs_src_internal_types_.schedulerlike.md)*): [Observable](_rxjs_src_internal_observable_.observable.md)<`T`>
...
*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:20*
...
▸ **dispatch**<`T`>(this: *[SchedulerAction](../interfaces/_rxjs_src_internal_types_.scheduleraction.md)<`T`>*, arg: *[DispatchArg](../interfaces/_rxjs_src_internal_observable_subscribeonobservable_.dispatcharg.md)<`T`>*): [Subscription](_rxjs_src_internal_subscription_.subscription.md)

*Defined in rxjs/src/internal/observable/SubscribeOnObservable.ts:25*
...
| arg | [DispatchArg](../interfaces/_rxjs_src_internal_observable_subscribeonobservable_.dispatcharg.md)<`T`> |
