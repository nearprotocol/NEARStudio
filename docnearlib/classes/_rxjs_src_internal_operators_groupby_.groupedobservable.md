[rxjs](../README.md) > ["rxjs/src/internal/operators/groupBy"](../modules/_rxjs_src_internal_operators_groupby_.md) > [GroupedObservable](../classes/_rxjs_src_internal_operators_groupby_.groupedobservable.md)
...
*__class__*: GroupedObservable<K, T>
...
* [constructor](_rxjs_src_internal_operators_groupby_.groupedobservable.md#constructor)

### Properties

* [_isScalar](_rxjs_src_internal_operators_groupby_.groupedobservable.md#_isscalar)
* [groupSubject](_rxjs_src_internal_operators_groupby_.groupedobservable.md#groupsubject)
* [key](_rxjs_src_internal_operators_groupby_.groupedobservable.md#key)
* [operator](_rxjs_src_internal_operators_groupby_.groupedobservable.md#operator)
* [refCountSubscription](_rxjs_src_internal_operators_groupby_.groupedobservable.md#refcountsubscription)
* [source](_rxjs_src_internal_operators_groupby_.groupedobservable.md#source)
* [if](_rxjs_src_internal_operators_groupby_.groupedobservable.md#if)
* [throw](_rxjs_src_internal_operators_groupby_.groupedobservable.md#throw)

### Methods

* [__computed](_rxjs_src_internal_operators_groupby_.groupedobservable.md#__computed)
* [_subscribe](_rxjs_src_internal_operators_groupby_.groupedobservable.md#_subscribe)
* [_trySubscribe](_rxjs_src_internal_operators_groupby_.groupedobservable.md#_trysubscribe)
* [forEach](_rxjs_src_internal_operators_groupby_.groupedobservable.md#foreach)
* [lift](_rxjs_src_internal_operators_groupby_.groupedobservable.md#lift)
* [pipe](_rxjs_src_internal_operators_groupby_.groupedobservable.md#pipe)
* [subscribe](_rxjs_src_internal_operators_groupby_.groupedobservable.md#subscribe)
* [toPromise](_rxjs_src_internal_operators_groupby_.groupedobservable.md#topromise)
* [create](_rxjs_src_internal_operators_groupby_.groupedobservable.md#create)
...
⊕ **new GroupedObservable**(key: *`K`*, groupSubject: *[Subject](_rxjs_src_internal_subject_.subject.md)<`T`>*, refCountSubscription?: *[RefCountSubscription](../interfaces/_rxjs_src_internal_operators_groupby_.refcountsubscription.md)*): [GroupedObservable](_rxjs_src_internal_operators_groupby_.groupedobservable.md)
...
*Defined in rxjs/src/internal/operators/groupBy.ts:277*

*__deprecated__*:
 Do not construct this type. Internal use only
...
| ------ | ------ |
| key | `K` |
| groupSubject | [Subject](_rxjs_src_internal_subject_.subject.md)<`T`> |
| `Optional` refCountSubscription | [RefCountSubscription](../interfaces/_rxjs_src_internal_operators_groupby_.refcountsubscription.md) |

**Returns:** [GroupedObservable](_rxjs_src_internal_operators_groupby_.groupedobservable.md)
...
*Defined in rxjs/src/internal/operators/groupBy.ts:280*
...
*Defined in rxjs/src/internal/operators/groupBy.ts:279*
...
___
<a id="refcountsubscription"></a>

### `<Private>``<Optional>` refCountSubscription

**● refCountSubscription**: *[RefCountSubscription](../interfaces/_rxjs_src_internal_operators_groupby_.refcountsubscription.md)*

*Defined in rxjs/src/internal/operators/groupBy.ts:281*
...
*Defined in rxjs/src/internal/operators/groupBy.ts:286*
